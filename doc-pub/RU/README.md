...
1. Позволяет использовать стрелки вверх/вниз/влево/вправо, `Home`, `End`, `Page Up`, `Page Down`, `Esc`, `Tab` и `Shift`+`Tab`.
...
4. Двойной тап по клавиатуре (без отпускания второго касания -- сразу можно начинать делать жест) активирует режим горизонтальных жестов. Отпускание деактивирует режим жестов по текстовому полю.

5. Тройной тап по клавиатуре (без отпускания третьего касания -- сразу можно начинать делать жест) активирует режим горизонтальных и вертикальных жестов. Отпускание деактивирует режим жестов по текстовому полю.
...
3. Можно добавлять поисковые плагины ([специальный раздел](https://github.com/tim-ecoder/KeyoneKB/wiki/%D0%A1%D0%BB%D0%BE%D0%B6%D0%BD%D1%8B%D0%B5-%D0%BD%D0%B0%D1%81%D1%82%D1%80%D0%BE%D0%B9%D0%BA%D0%B8)); например, уже добавлен плагин для ExDialer.
