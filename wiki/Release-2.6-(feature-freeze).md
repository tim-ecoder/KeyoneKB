...
**BUGFIX:** Slightly changed search_plugins behavior for bb.contacts, bb.dialer;
...
**CLICKER_PLUGINS:** Reminder — clicker_plugin clicks on text input when entering a dialog and starting to type; ru.fourpda.client, +avito, +kate
